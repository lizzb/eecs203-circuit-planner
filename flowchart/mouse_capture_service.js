...
.factory('mouseCapture', function ($rootScope) {
	...
	return {
		...
		// Register an element to use as the mouse capture element
		// instead of the default [which is the document].
...
.directive('mouseCapture', function () {
  return {
  	...
  	controller: function($scope, $element, $attrs, mouseCapture) {
  		...
  		// Register the directives element
  		// as the mouse capture element.
